...
BATCH_SIZE  = 16;
MAX_EPOCHS  = 50;      % Hard cap — early stopping will usually trigger well before this
INIT_LR     = 1e-4;
...
%  Training Options
% =========================================================================
% Early stopping: halt after 8 consecutive validation checks with no
% improvement in loss. ValidationFrequency=5 means a check every 5
% mini-batch iterations. OutputNetwork='best-validation-loss' rolls
% back to the peak checkpoint, not the final (potentially overfit) epoch.
